...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @Bind(R.id.savedProductBtn) Button mSavedProductBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSavedProductBtn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if(v == mSavedProductBtn) {
            Intent intent = new Intent(MainActivity.this, SavedProductListActivity.class);
            startActivity(intent);
        }
    }
}
